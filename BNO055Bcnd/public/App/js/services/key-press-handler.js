angular.module("gameApp")
    .service("keyPressHandlerService", ["characterDirection","gameStateService", function(characterDirection,gameStateService) {
        var KeyPressEnum = {
            DownUnprocessed: 0,
            DownProcessed: 1,
            Up: 2
        ...
        var blur=function()
        {   
         document.getElementById("gam_area").setAttribute('class', 'blur');
        }
        var unblur=function()
        {   
         document.getElementById("gam_area").setAttribute('class', '');
        }
        function processKeyCode(keyCode) {
            switch (keyCode) {
                ...
                case 9:unblur();
                    break;
                case 68:gameStateService.die();//d
                    break;
                case 82: gameStateService.reset();   //r
                    break;
                case 76:gameStateService.startLevelTransition();//l
                    break;
                default:
